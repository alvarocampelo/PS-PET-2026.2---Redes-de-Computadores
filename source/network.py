...
def mandarmensagem(conexao, mensagem): # essa função recebe a conexão e a mensagem do usuário, e envia para o outro usuário conectado. "utf-8" garante que os bytes serão convertidos para inteiros.
